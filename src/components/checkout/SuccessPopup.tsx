        ...
        <div className="bg-white rounded-2xl max-w-md w-full shadow-xl animate-in fade-in zoom-in duration-300">
          ...
          <div className="relative p-6 text-center border-b border-gray-100">
            ...
            <p className="text-gray-500 text-sm mt-2">
              {t('checkout.thankYou')} <span className="font-semibold text-[#2ECC71]">{t('checkout.storeName')}</span>، 
          ...
          <div className="p-6 pt-0 flex gap-3">
            <button
              ...
              className="flex-1 bg-[#2ECC71] text-white py-3 rounded-[8px] font-medium hover:bg-[#2ECC71] transition shadow-sm"
            >
