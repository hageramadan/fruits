          ...
          <div className="w-1/2 md:w-1/2 text-center md:text-right pt-2 md:pt-0">
            <div className="max-w-xl mx-auto md:mx-0">
              ...
              <div className="inline-block">
                <p className="text-[8px] md:text-[16px] font-semibold px-1.5 py-0.5 md:px-4 md:py-1.5 bg-[#2ECC71]/10 text-[#2ECC71] rounded-full inline-block">
                  لفترة محدودة
                </p>
              </div>
              ...
              <div className="mt-1 md:mt-6">
                ...
                <div className="w-10 md:w-20 h-0.5 md:h-1 bg-[#2ECC71] rounded-full mt-0.5 md:mt-2 mx-auto md:mx-0"></div>
              </div>
