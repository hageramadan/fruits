      ...
      <section className={`overflow-hidden ${variant === 'dark' ? 'bg-[#141718]' : 'bg-gradient-to-r from-[#FFF5F4] to-[#FFE8E6]'}`}>
        <div className="flex justify-center items-center min-h-[200px] md:min-h-[300px]">
          <div className="relative">
            ...
            <div className="absolute top-0 left-0 w-8 h-8 md:w-12 md:h-12 border-4 border-[#2ECC71] border-t-transparent rounded-full animate-spin"></div>
          </div>
        </div>
      </section>
    );
          ...
          <div className="w-1/2 md:w-1/2 text-center md:text-right pt-2 md:pt-0">
            <div className="max-w-xl mx-auto md:mx-0">
              <div className="inline-block">
                <p className="text-[8px] md:text-[16px] font-semibold px-1.5 py-0.5 md:px-4 md:py-1.5 bg-black/10 text-[#2ECC71] rounded-full inline-block">
                  لفترة محدودة
                </p>
              </div>
              
              <div className="mt-1 md:mt-6">
                <p className="text-[14px] md:text-[48px] font-bold text-[#2ECC71]">
                  خصم {discount}%
                </p>
