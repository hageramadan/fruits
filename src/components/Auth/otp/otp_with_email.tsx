        ...
        <div className="max-w-md w-full bg-white rounded-2xl shadow-lg p-6 md:p-8">
          ...
          <form onSubmit={handleSubmit}>
            <div className="flex justify-between gap-2 mb-6 flex-row-reverse" dir="rtl">
              {otp.map((digit, index) => (
                <input
                  ...
                  onPaste={handlePaste}
                  disabled={isLoading}
                  className="w-12 h-12 md:w-14 md:h-14 text-center text-xl font-bold border-2 border-gray-300 rounded-[8px] focus:border-[#2ECC71] focus:ring-2 focus:ring-[#2ECC71]/20 outline-none transition-all disabled:opacity-50"
                  maxLength={1}
                  dir="ltr"
                />
              ))}
            ...
            <div className="text-center mb-6">
              {!canResend ? (
                ...
                <button
                  ...
                  disabled={isLoading}
                  className="text-[#2ECC71] font-medium hover:underline transition disabled:opacity-50"
                >
                  {t("auth.resendCode")}
                </button>
              )}
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 bg-[#2ECC71] text-white rounded-[8px] hover:bg-[#2ECC71] transition disabled:opacity-50 font-medium"
            >
              {isLoading ? (
                <>
