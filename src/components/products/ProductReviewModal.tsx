    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4 bg-black/50 backdrop-blur-sm animate-fadeIn">
      <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl">
        ...
        <p className="text-sm text-gray-600 mb-4 line-clamp-2">
          {text.productLabel}{' '}
          <span className="font-bold text-[#2ECC71]">{productName}</span>
        </p>
        ...
        <textarea
          ...
          className="w-full p-3 border border-gray-200 rounded-[8px] focus:outline-none focus:border-[#2ECC71] focus:ring-2 focus:ring-[#2ECC71]/20 resize-none bg-gray-50 min-h-[100px] transition"
        ...
        <div className="flex gap-3 mt-4">
          ...
          <button
            ...
            className="flex-1 py-2.5 rounded-[8px] bg-[#2ECC71] text-white font-medium hover:bg-[#a880a6] transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
