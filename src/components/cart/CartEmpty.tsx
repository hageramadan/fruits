  ...
  return (
    <div className="container h-[80vh]">
      ...
      <div className="text-center rounded-2xl mt-5">
        ...
        <Link
          href="/products"
          className="inline-block bg-[#2ECC71] text-white px-8 py-3 rounded-[8px] font-semibold hover:bg-[#2ECC71] transition-all duration-300 shadow-md hover:shadow-lg"
        >
          {t('cartEmpty.shopNow')}
        </Link>
      </div>
...
const PageHeader = ({ title, t }: { title: string; t: any }) => (
  <div className="page-with-padding">
    ...
    <div className="flex items-center gap-2 mt-2 text-sm text-gray-500">
      <Link href="/" className="hover:text-[#2ECC71]">{t('cartEmpty.home')}</Link>
