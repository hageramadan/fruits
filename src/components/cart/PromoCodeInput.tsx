    ...
    <div className="mt-4">
      <div className="flex gap-2">
        <input
          ...
          disabled={isLoading}
          className={`px-2 md:px-4 py-2.5 w-[90%] lg:w-full border rounded-[8px] focus:outline-none focus:ring-2 focus:ring-[#2ECC71] focus:border-[#2ECC71] text-sm disabled:bg-gray-100 ${
        ...
        <button
          ...
          className="px-3 md:px-5 w-fit md:py-2.5 bg-[#2ECC71] text-white rounded-[8px] text-sm font-semibold hover:bg-[#2ECC71] transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
        >
