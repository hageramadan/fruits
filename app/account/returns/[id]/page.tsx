    ...
    return (
      <div className="min-h-screen bg-gradient-to-l from-[#bdcbf12a] to-[#feecea3b] page-with-padding">
        <div className="container mx-auto px-4 py-8 text-center">
          ...
          <Link href="/account/returns" className="inline-block bg-[#2ECC71] text-white px-6 py-2 rounded-[8px] hover:bg-[#2ECC71] transition">
    ...
    <div className="min-h-screen bg-gradient-to-l from-[#bdcbf12a] to-[#feecea3b] page-with-padding">
      <div className="container mx-auto mb-3 px-4 md:px-8">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-4">
          ...
          <Link href="/account/returns" className="hover:text-[#2ECC71] transition">{t('returns.title')}</Link>
          <ChevronRight className="w-4 h-4" />
          <span className="text-[#2ECC71] font-medium">{t('orders.orderDetails')}</span>
        </div>
                  ...
                  <div className="flex flex-wrap items-center gap-2 sm:gap-4">
                    <div className="flex gap-2 sm:gap-4 items-center text-base sm:text-[20px] font-bold text-[#180100]">
                      ...
                      <div className="flex gap-1 sm:gap-2 items-center">
                        ...
                        <IoCopyOutline 
                          className={`w-4 h-4 sm:w-5 sm:h-5 cursor-pointer transition ${copied ? 'text-green-500' : 'hover:text-[#2ECC71]'}`}
                      ...
                      <div className="flex-1 md:text-right text-center">
                        <div className="flex flex-col md:flex-row gap-3 md:justify-between items-center md:items-start">
                          ...
                          <div className="text-left">
                            <p className="font-bold text-[#2ECC71]">{currencySymbol} {item.total_price.toFixed(2)}</p>
              ...
              <div className="space-y-3">
                ...
                {returnData.order.coupon_discount_amount > 0 && (
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-[#2ECC71]">-{currencySymbol} {returnData.order.coupon_discount_amount.toFixed(2)}</span>
                  </div>
                )}
                {returnData.order.total_discount_amount > 0 && (
                  <div className="flex justify-between">
                    <span className="text-gray-500">{t('orders.totalDiscount')}</span>
                    <span className="font-bold text-[#2ECC71]">-{currencySymbol} {returnData.order.total_discount_amount.toFixed(2)}</span>
                  </div>
                )}
                <div className="flex justify-between">
                ...
                <div className="flex justify-between py-3 border-t border-gray-200 mt-2">
                  ...
                  <span className="text-xl font-bold text-[#2ECC71]">{currencySymbol} {totalRefund.toFixed(2)}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              ...
              <textarea
                ...
                className="w-full p-3 border border-gray-200 rounded-[8px] focus:outline-none focus:border-[#2ECC71] resize-none bg-gray-50"
                rows={3}
                readOnly
              />
            </div>
