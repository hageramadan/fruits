    ...
    return (
      <div className="min-h-screen bg-gradient-to-l from-[#bdcbf12a] to-[#feecea3b] page-with-padding">
        <div className="container mx-auto px-4 py-8 text-center">
          ...
          <Link
            href="/account/orders"
            className="inline-block bg-[#2ECC71] text-white px-6 py-2 rounded-[8px] hover:bg-[#2ECC71] transition"
          >
      ...
      <div className="min-h-screen bg-gradient-to-l from-[#bdcbf12a] to-[#feecea3b] page-with-padding">
        <div className="container mx-auto mb-3 px-4 md:px-8">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-500 mb-4 md:mb-5">
            <Link href="/account" className="hover:text-[#2ECC71] transition">
              {t("account.myAccount")}
            </Link>
                              ...
                              <div className="mt-2">
                                {hasRated ? (
                                  ...
                                  <button
                                    ...
                                    className="flex items-center gap-1 text-sm text-[#2ECC71] hover:text-[#a880a6] transition font-medium"
                                  >
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                {showRetryButton && (
                  <button
                    ...
                    className="mt-4 w-full flex items-center justify-center gap-2 bg-[#2ECC71] text-white py-2.5 rounded-[8px] font-medium hover:bg-[#2ECC71] transition disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isRetryingPayment ? (
                      <>
          ...
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl animate-fadeIn">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled={isCancelling}
                className="flex-1 py-2.5 rounded-[8px] bg-[#2ECC71] text-white font-medium hover:bg-[#2ECC71] transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isCancelling ? (
                  <>
                    <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" />
